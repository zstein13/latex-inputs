...
The \ThisSystem described in this document shall be known as \ThisSys version 1.0. The \ThisSystem may also be referred toas \ThisSys v1. 
The \SVD and other design documents are intended for those interested in replicating or building \ThisSystem.
...
As of now, there are no security or privacy concerns. This will be updated if applicable.
