%%% SVN stuff
\svnidlong
{$HeadURL: https://svn.riouxsvn.com/kneadlatxinputs/ExampleArtifactFolders/7%20-%20SVD/SVD_doc_history.tex $}
{$LastChangedDate: 2023-12-24 20:59:28 -0500 (Sun, 24 Dec 2023) $}
{$LastChangedRevision: 30 $}
{$LastChangedBy: KneadProject $}
\svnid{$Id: SVD_doc_history.tex 30 2023-12-25 01:59:28Z KneadProject $}
...
\begin{table}[h]
    ...
    \multicolumn{4}{l}{\bfseries Change Record} \\
		...
		\hline
		\hline
			 22 Dec 2023	&	\centering	P1	&	{\raggedright Lewis Collier}	&	Preliminary DRAFT version  \\ \hline
			 08 Mar 2024	&	\centering	v0.1	&	{\raggedright Zachary Steinberg}	&	DRAFT version  \\ \hline
		\hline		
		\hline				
  	\end{tabular}
