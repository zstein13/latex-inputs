...
Test \StsTestSpecID{Environmental Threshold Test} case \StsTestCaseID{Temperature Threshold} will verify and validate that the Garden Control System successfully 
...
This requirements validated by test \StsTestSpecID{Environmental Threshold Test} case \StsTestCaseID{Temperature Threshold} are listed in \S~\ref{loc:TestCaseProcedure\StsTestSpecID\StsTestCaseID}.
...
This prerequisite condition for test \StsTestSpecID{Environmental Threshold Test} case \StsTestCaseID{Temperature Threshold} is a functional temperature sensor and working firmware for \ThisSys.

\subsubsection{Inputs}
\label{loc:TestCaseInputs\StsTestSpecID\StsTestCaseID}
% \input{DIDINFO_Snippets/STS/STS_4.x.y.3_DIDINFO.tex}

This inputs for test \StsTestSpecID{Environmental Threshold Test} case \StsTestCaseID{Temperature Threshold} are listed in \S~\ref{loc:TestCaseProcedure\StsTestSpecID\StsTestCaseID}.
...
This expected outputs for test \StsTestSpecID{Environmental Threshold Test} case \StsTestCaseID{Temperature Threshold} are listed in \S~\ref{loc:TestCaseProcedure\StsTestSpecID\StsTestCaseID}.

\subsubsection{Evaluation Criteria}
\label{loc:TestCaseEvaluationCriteria\StsTestSpecID\StsTestCaseID}
% \input{DIDINFO_Snippets/STS/STS_4.x.y.5_DIDINFO.tex}

This evaluation criteria for test \StsTestSpecID{Environmental Threshold Test} case \StsTestCaseID{Temperature Threshold} are listed in \S~\ref{loc:TestCaseProcedure\StsTestSpecID\StsTestCaseID}.
...
This assumptions and constraints for test \StsTestSpecID{Environmental Threshold Test} case \StsTestCaseID{Temperature Threshold} are:
...
This procedure for test \StsTestSpecID{Environmental Threshold Test} case \StsTestCaseID{Temperature Threshold} is to vary the environmental temperature and verify that the temperature sensor is measuring accurate temperature.
...
{%4%-RQMTS
\tpRqmt{Starting temperature and measured temperature should be within 0.5\degree F.}

}%4%-RQMTS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%arg-5 is list of notes for this test procedure label
{%5%-NOTES
\tpNote{0.5\degree F is the temperature sensors margin of error}
}%5%-NOTES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\tpStepINFO{Raise temperature to 90\degree for 10 minutes}
\tpStepINFO{Lower temperature back to room temperature}
