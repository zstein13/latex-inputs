%%% SVN stuff
\svnidlong
{$HeadURL: https://svn.riouxsvn.com/kneadlatxinputs/ExampleArtifactFolders/6a-STP/STP_doc_history.tex $}
{$LastChangedDate: 2024-02-25 09:33:45 -0500 (Sun, 25 Feb 2024) $}
{$LastChangedRevision: 85 $}
{$LastChangedBy: KneadProject $}
\svnid{$Id: STP_doc_history.tex 85 2024-02-25 14:33:45Z KneadProject $}
...
\begin{table}[h]
    ...
    \multicolumn{4}{l}{\bfseries Change Record} \\
		...
		\hline
		\hline
			 25 Feb	2024	&	\centering	P1	&	{\raggedright Lewis Collier}	&	1st draft version \\ \hline
			 02 May	2024	&	\centering	v0.1	&	{\raggedright Zachary Steinberg}	&	1st draft version \\ \hline
